...
sections.append("""# HubArena - Backend REST - Sprint 1
...
sections.append("""## 2. Perfis de Usuário
...
sections.append("""## 3. Tecnologias Utilizadas
...
sections.append("""## 4. Arquitetura do Backend
...
sections.append("""## 5. Componentes Arquiteturais
...
sections.append("""## 6. Diagrama de Arquitetura
...
sections.append("""## 7. Banco de Dados
...
sections.append("""## 8. Como Executar
...
sections.append("""## 9. Endpoints Implementados
...
sections.append("""## 10. Fluxo Principal Validado
...
sections.append("""## 11. Coleção Postman
...
sections.append("""## 12. Eventos Previstos para Sprint 2
...
sections.append("""## 13. Estrutura de Pastas
